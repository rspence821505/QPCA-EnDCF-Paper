...
For clarity, we describe the construction here at the algorithmic level; the corresponding population and sample objects (forecast distribution, stacked QoI map, whitened residual covariances, spectral projectors, and empirical gains) are defined precisely in Section~\ref{subsec:practical_considerations}.
