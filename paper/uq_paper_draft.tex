...
\end{equation}
where $\mathbf{Z}^{(w)}\in\mathbb{R}^{d\times N}$ contains the stacked forecast observations for all ensemble members. The scalar form $\sigma_{\mathrm{obs}}^{-1}$ is used when $\mathbf{R}^{(L)}$ is diagonal; implementation details for non-diagonal covariances are provided in Section~\ref{subsec:correlated_errors}.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{fig_inflation_multiplicative.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{fig_inflation_additive.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{noise_distributions.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{mean_rmse_comparison_nongaussian.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{rmse_trajectories_nongaussian.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{correlation_structures.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{reconstruction_errors.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{performance_degradation.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{fig_ensemble_size_spread_skill.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{combined_window_rmse_analysis.png}
...
% 	$\mathbf{z}^{(w)}$ & $\mathbb{R}^{d}$ & Stacked observations over window $w$, $\mathbf{z}^{(w)}=[\mathbf{z}_{k_0(w)+1}^\top,\ldots,\mathbf{z}_{k_w}^\top]^\top$ \\
...
% Let $\mathbf{X}_{k_w}\in\mathbb{R}^{n\times N}$ be the forecast ensemble at the assimilation time (or window endpoint) and
% $\mathbf{Z}^{(w)}\in\mathbb{R}^{d\times N}$ the stacked forecast observations. Define
% \[
% \mathbf{A}_x := \mathbf{X}_{k_w}-\bar{\mathbf{x}}_{k_w}^f\mathbf{1}^\top,
% \qquad
% \mathbf{A}_z := \mathbf{Z}^{(w)}-\bar{\mathbf{y}}_{\mathrm{stack}}\mathbf{1}^\top,
% \]
% and
% \[
