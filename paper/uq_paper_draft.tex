...
\mathrm{Var}(N,\kappa,s):=\mathbb{E}\!\left[\|\bar{\mathbf{x}}^{a,s}-\mathbb{E}[\bar{\mathbf{x}}^{a,s}]\|^2\right].
	...
	:=
	\bigl\|\boldsymbol{\mu}^f-\mathbf{x}^{\mathrm{true}}-\mathbb{E}[\mathbf{K}^{\mathrm{DC}}](\mathbf{R}^{(L)})^{1/2}\boldsymbol{\mu}_E^{\,s}\bigr\|^2,
	\]
	\begin{align}
...
\smallskip
	...
	:=
	\boldsymbol{\mu}^f-\mathbf{x}^{\mathrm{true}}-\mathbb{E}[\mathbf{K}^{\mathrm{DC}}](\mathbf{R}^{(L)})^{1/2}\boldsymbol{\mu}_E^{\,s}.
	\]
